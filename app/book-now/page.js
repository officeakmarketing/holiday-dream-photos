    ...
    <div className="bg-[#F9F7F4] min-h-screen">
      <div className="max-w-[1000px] mx-auto px-4 sm:px-6 pb-32 pt-40 lg:pt-56">
        ...
        <div className="text-center mb-20">
          ...
          <h1 className="font-bodoni text-6xl md:text-[5.5rem] text-[#113122] mb-8 leading-none tracking-tight">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 mb-24 border-y border-gray-200 py-12">
          <div className="text-center px-4">
            <span className="text-brand-red font-bodoni text-2xl italic mb-3 block">01.</span>
            <p className="font-bodoni text-[#113122] text-xl mb-2">Location</p>
          ...
          <div className="text-center px-4 border-t md:border-t-0 md:border-l md:border-r border-gray-200 pt-12 md:pt-0">
            <span className="text-brand-red font-bodoni text-2xl italic mb-3 block">02.</span>
            <p className="font-bodoni text-[#113122] text-xl mb-2">Experience</p>
          ...
          <div className="text-center px-4 border-t md:border-t-0 border-gray-200 pt-12 md:pt-0">
            <span className="text-brand-red font-bodoni text-2xl italic mb-3 block">03.</span>
            <p className="font-bodoni text-[#113122] text-xl mb-2">Confirm</p>
        ...
        <div className="bg-white border border-gray-200 min-h-[700px] flex flex-col relative w-full">
          ...
          <div className="flex-1 flex flex-col items-center justify-center p-12 text-center w-full">
            ...
            <p className="font-bodoni text-3xl text-[#113122] mb-4">Scheduling Loading...</p>
