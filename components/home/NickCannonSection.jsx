      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
        ...
        <div className="text-center mb-8 md:mb-12 relative">
          <div className="relative inline-block w-full">
            ...
            <h2 className="relative z-10 font-heading text-2xl sm:text-4xl md:text-5xl text-brand-dark tracking-tight leading-tight px-4 whitespace-nowrap">
              Loved by <span className="italic text-brand-red drop-shadow-sm">everyone</span>
            </h2>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto w-full mt-6 md:mt-12">
          <FadeIn
            y={40}
            duration={0.8}
            className="flex flex-col relative px-4 py-6 sm:p-12 lg:p-16 text-center rounded-2xl md:rounded-3xl bg-white shadow-[0_20px_60px_rgba(0,0,0,0.05)] border border-gray-100/60 transition-all duration-500 w-full hover:-translate-y-2 hover:shadow-[0_40px_80px_-20px_rgba(0,0,0,0.1)]"
          >
            ...
            <div className="flex justify-center gap-2 mb-4 sm:mb-8 relative z-10 pt-2 sm:pt-4">
              {[...Array(5)].map((_, i) => (
                <Star key={i} className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-brand-dark fill-brand-dark" />
              ))}
            </div>

            <p className="text-gray-800 font-heading text-base sm:text-2xl lg:text-3xl leading-relaxed sm:leading-[1.6] italic mb-6 sm:mb-10 relative z-10 max-w-3xl mx-auto px-1 sm:px-0">
            ...
            <div className="flex flex-col items-center justify-center relative z-10 mt-4 sm:mt-6">
              <span className="font-bold text-brand-dark uppercase tracking-[0.15em] text-[10px] sm:text-xs md:text-sm mb-1.5 sm:mb-2.5 max-w-[250px] sm:max-w-none text-center">
                Baldwin Hills Crenshaw Shopping Center
              </span>
              <span className="text-brand-red text-[9px] md:text-xs uppercase tracking-[0.3em] font-bold">
                Verified Partner
              </span>

              {/* Nick Cannon Photo */}
              <div className="flex flex-col items-center mt-6 sm:mt-10">
                <div className="relative w-36 h-36 sm:w-64 sm:h-64 md:w-72 md:h-72 shadow-lg transition-transform duration-500 rounded-sm bg-white p-1 sm:p-2">
                  <Image 
