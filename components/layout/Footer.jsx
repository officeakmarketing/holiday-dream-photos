  ...
  return (
    <footer className="w-full bg-[#F9F7F4] pt-28 lg:pt-36 pb-12 relative overflow-hidden border-t border-[#113122]/10">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20 isolate">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-20 text-[#113122]">
          {/* Left Column */}
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <p className="text-[#113122]/60 font-bodoni italic text-xl text-center">
          ...
          <div className="flex flex-col items-center md:items-end text-center md:text-right">
            ...
            <div className="flex flex-col gap-4">
              <a href="mailto:hello@holidaydreamphotos.com" className="text-[#113122]/70 hover:text-[#113122] transition-colors text-sm font-medium">hello@holidaydreamphotos.com</a>
              <div className="flex gap-4 mt-2 justify-center md:justify-end">
                <a href="https://www.instagram.com/holidaydreamphotos" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-[#113122]/20 flex items-center justify-center text-[#113122]/70 hover:bg-[#113122] hover:text-[#F9F7F4] hover:border-[#113122] transition-all duration-300">
                ...
                <a href="https://www.facebook.com/holidaydreamphotos" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-[#113122]/20 flex items-center justify-center text-[#113122]/70 hover:bg-[#113122] hover:text-[#F9F7F4] hover:border-[#113122] transition-all duration-300">
