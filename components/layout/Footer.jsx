      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20 isolate">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-20 text-brand-dark">
          ...
          <div className="flex flex-col items-center md:items-end text-center md:text-right">
            ...
            <div className="flex flex-col gap-4">
              <a href="tel:678-325-1232" className="text-brand-dark/70 hover:text-brand-dark transition-colors text-sm font-medium">678-325-1232</a>
              <a href="mailto:info@holidaydreamphotos.com" className="text-brand-dark/70 hover:text-brand-dark transition-colors text-sm font-medium">Info@holidaydreamphotos.com</a>
