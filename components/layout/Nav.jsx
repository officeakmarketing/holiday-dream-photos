        ...
        {mobileMenuOpen && (
          ...
          >
            ...
            <div className="w-full lg:w-1/2 min-h-[100svh] lg:h-screen flex flex-col justify-between p-6 sm:p-12 order-1 lg:order-2 bg-brand-light relative">
              ...
              <div className="flex justify-between items-start lg:items-center w-full mb-8 lg:mb-12 shrink-0">
                ...
                <div className="hidden lg:flex flex-1 items-center justify-between gap-8 mr-8 lg:pl-4">
                  <Link
                    ...
                    className="inline-block bg-brand-red text-white text-[11px] font-bold uppercase tracking-[0.3em] px-6 py-3.5 hover:bg-brand-dark transition-colors rounded-sm"
                  >
                    Book Your Session
                  </Link>
              ...
              {/* Footer CTA & Socials (Visible on mobile/tablet, hidden on desktop) */}
              <m.div
                variants={{
                  hidden: { opacity: 0, y: 20 },
                  visible: { opacity: 1, y: 0, transition: { duration: 0.8, delay: 0.4, ease: [0.22, 1, 0.36, 1] } }
                }}
                className="w-full flex lg:hidden flex-col sm:flex-row items-start sm:items-center justify-between border-t border-brand-dark/10 pt-6 mt-6 shrink-0 gap-6"
              >
                <Link
                  href="/book-now"
                  onClick={() => setTimeout(() => setMobileMenuOpen(false), 200)}
